...
namespace Kiwi.Tpv.App.Util
{
    public class RawPrinterHelper
    {
        ...
        public static bool IsPrinterConnectedAndOnline(string printerName)
        {
            try
            {
                ...
                foreach (var o in searcher.Get())
                {
                    ...
                    if (!printer["Name"].ToString().ToUpper().Equals(printerName.ToUpper())) continue;
                    return Convert.ToInt16(printer["PrinterStatus"]) == 3;                 
                }
